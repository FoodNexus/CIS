    ...
    <div class="max-w-2xl mx-auto p-6">
      ...
      <form [formGroup]="postForm" (ngSubmit)="onSubmit()" class="space-y-4">
        ...
        <div>
          ...
          <textarea formControlName="content" rows="6" placeholder="What's on your mind?" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-emerald-500 focus:ring-emerald-500 sm:text-sm border px-3 py-2"></textarea>
